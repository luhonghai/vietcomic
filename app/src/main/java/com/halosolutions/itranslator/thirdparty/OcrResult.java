...
/**
 * Created by longnguyen on 6/28/15.
 *
...
public class OcrResult {
    ...
    public OcrResult(Bitmap bitmap, String text, int[] wordConfidences, int meanConfidences, List<Rect> regionBoundingBoxes
                     ,List<Rect> textlineBoundingBoxes, List<Rect> wordBoudingBoxes, List<Rect> stripBoundingBoxes, List<Rect> characterBoundingBoxes
                     ,long recognitionTimeRequired){
        this.bitmap = bitmap;
        this.text = text;
        this.wordConfidences = wordConfidences;
        this.meanConfidence = meanConfidences;
        this.regionBoundingBoxes = regionBoundingBoxes;
        this.textlineBoundingBoxes = textlineBoundingBoxes;
        this.wordBoundingBoxes = wordBoudingBoxes;
