...
final class CameraConfigurationManager {
    ...
    void setDesiredCameraParameters(Camera camera) {
        ...
        if (prefs.getBoolean(PrefFragment.KEY_AUTO_FOCUS, true)) {
            if (prefs.getBoolean(PrefFragment.KEY_DISABLE_CONTINUOUS_FOCUS, false)) {
    ...
    void setTorch(Camera camera, boolean newSetting) {
        ...
        camera.setParameters(parameters);
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        boolean currentSetting = prefs.getBoolean(PrefFragment.KEY_TOGGLE_LIGHT, false);
        if (currentSetting != newSetting) {
            SharedPreferences.Editor editor = prefs.edit();
            editor.putBoolean(PrefFragment.KEY_TOGGLE_LIGHT, newSetting);
            editor.commit();
        }
    }
