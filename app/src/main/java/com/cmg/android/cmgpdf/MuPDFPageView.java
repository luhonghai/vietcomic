...
public class MuPDFPageView extends PageView implements MuPDFView {
	...
	@Override
	protected Bitmap updatePage(BitmapHolder bh, int sizeX, int sizeY,
			int patchX, int patchY, int patchWidth, int patchHeight) {
		return mCore.updatePage(bh, mPageNumber, sizeX, sizeY, patchX, patchY, patchWidth, patchHeight);
	}
