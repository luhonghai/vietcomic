...
public class ReaderView
	...
	public boolean onDoubleTap(MotionEvent e) {
		// Added by Hai for double to zoom in/out
		...
		mScale = Math.min(Math.max(previousScale > 1.0f ? 1.0f : 3.0f, min_scale), max_scale);
	...
	/**
	 * (non-Javadoc)
	 * @see GestureDetector.OnDoubleTapListener#onDoubleTapEvent(MotionEvent)
	 */
	@Override
