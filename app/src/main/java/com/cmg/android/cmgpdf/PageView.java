...
public abstract class PageView extends ViewGroup {
	private static final int HIGHLIGHT_COLOR = 0x80FFFF00;
	...
	protected abstract Bitmap updatePage(BitmapHolder bm, int sizeX, int sizeY, int patchX, int patchY, int patchWidth, int patchHeight);
